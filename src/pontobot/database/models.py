...
class SafeDateTimeField(fields.DatetimeField):
    """Custom field to safely parse SQLite ISO timestamps into Python datetime objects."""

    def to_python_value(self, value: object) -> datetime | None:
...
class Guild(Model):
    ...
    master_role_id = fields.BigIntField(null=False)
    special_role_id = fields.BigIntField(null=False)
